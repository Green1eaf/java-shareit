...
public class ItemController {
    ...
    @PostMapping
    public ItemDto create(@RequestBody @Valid ItemDto itemDto, @RequestHeader(USER) long userId) {
    ...
    @GetMapping
    public List<ItemDto> findAllByUserId(@RequestHeader(USER) long userId) {
